<template>
	<view>
		...
		<view class="whdata juzho"><textarea class="lmtext" maxlength="200" v-model="nrData" placeholder="请输入您的详细问题，我们将尽快解决。" auto-height /></view>
		<view class="zgsxiagx juzho">字数限制200个</view>
		<view class="zgscjimg juzho">
			<view class="zgsdiv" v-if="imgData">
			<view class="zgscdiv">
				<image class="img" :src="imgData"></image>
		...
		methods: {
			...
			pressure: function(imgData) {
				...
				uni.compressImage({
					...
					quality: 80,
					success: res => {
						_this.imgData=res.tempFilePath;
					}
				})
