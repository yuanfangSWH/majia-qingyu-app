<template>
	<div class="banner-container">
		<swiper :style="{width: '100vw', height: '990rpx'}" :indicator-dots="swiperConfig.indicatorDots" :indicator-color="swiperConfig.indicatorColor"
...
<script>
	export default {
		...
		methods: {
			swiperChange(e) {
				//向父传递参数
				this.$emit("changes",e.mp.detail.current);
				//传递结束
				const that = this
